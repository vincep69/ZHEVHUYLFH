		...
		<div class="input-group">
		  ...
		  if ($_SESSION['grade']<50) {
			  	...
			  	if (isset($_GET['rapport'])) {
					...
					?>
			  		<input type="text" name="motif" class="form-control" placeholder="Mot de Passe" aria-describedby="basic-addon1">
			  		<?php
				}
			}
		  ?>
  ...
  <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
		<div class="input-group">
		  ...
		  if ($_SESSION['grade']<50) {
			  	...
			  	if (isset($_GET['rapport'])) {
			  		?><input type="text" name="numpraticien" class="form-control" value="<?php echo $data['PRA_NUM']; ?>" aria-describedby="basic-addon1"><?php
			  	}else{
					?>
